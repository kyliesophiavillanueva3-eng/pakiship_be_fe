...
const mascotWavingImg = require('../../../assets/mascot-star.png');
const mascotWinkingImg = require('../../../assets/mascot-parcel.png');
const mascotMotorcycleImg = require('../../../assets/mascot-track.png');
const mascotThinkingImg = require('../../../assets/mascot-shield.png');
const mascotSendParcel = require('../../../assets/mascot-send-parcel.png');
const mascotHistory = require('../../../assets/mascot-history.png');
const mascotRate = require('../../../assets/mascot-rate.png');
const mascotTracking = require('../../../assets/mascot-tracking.png');
...
export default function TutorialModal({
  ...
  useEffect(() => {
    ...
    const t6 = setTimeout(measureHighlight, 800);
    const interval = setInterval(measureHighlight, 1200); // Continuous check for accuracy
