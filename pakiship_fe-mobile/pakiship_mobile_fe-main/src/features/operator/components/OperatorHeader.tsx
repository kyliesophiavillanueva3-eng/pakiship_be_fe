...
export function OperatorHeader({ showBack, onBackPress }: HeaderProps) {
  ...
  return (
    <View style={[styles.container, { paddingTop: topPad + 10 }]}>
      ...
      <View style={styles.right}>
        ...
        {!showBack && <TouchableOpacity style={styles.logoutBtn} onPress={() => setShowLogoutModal(true)}>
      ...
      <Modal transparent visible={showLogoutModal} animationType="fade">
        <View style={styles.logoutOverlay}>
          ...
          <View style={styles.logoutCard}>
            ...
            <Text style={styles.logoutBody}>Are you sure you want to return to the login screen?</Text>

            <View style={styles.logoutActions}>
              <Pressable style={styles.confirmButton} onPress={handleLogout}>
                <Text style={styles.confirmText}>Yes, Logout</Text>
              </Pressable>
              <Pressable style={styles.cancelButton} onPress={() => setShowLogoutModal(false)}>
